...
builder.Services.AddDbContext<DotnetAngularDemo05Context>(opt => opt.UseNpgsql(builder.Configuration.GetConnectionString("dotnet-angular-demo-05-connection-sctring")));
